...
def explain_prediction(img_path : str, xDNN_learned_dict_path : str, output_dir : str, 
    ...
    if classes_names is not None:
        numClasses = len(classes_names)
    else:
        numClasses = learned_dict['xDNNParms']['CurrentNumberofClass']
    ...
    def batch_predict(images):
        ...
        return np.array(Output2['Scores'])
