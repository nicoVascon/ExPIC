...
from X_MAN.xDNN.Models.xDNN_class_OfflinevCDE_Plot import *
...
def run(models_dir=models_dir, outputDir= None, **kwargs):
    ...
    for model_dir in trainings:
        ...
        kwargs['config_dic'] = config_dic
        Output1 = xDNN(Input1,Mode1, **kwargs)
        ...
        Mode2 = 'Validation'
        Output2 = xDNN(Input2,Mode2, **kwargs)
    ...
    if config_dic.get('Custom_Clustering') is not None:
        config_dic.pop('Custom_Clustering')
...
# result = run("/nfs/home/nvasconcellos.it/softLinkTests/xDNN_Covid19_Det/xDNN---Python/FineTuning/results/FineTuning_VGG16_CB/NeuralNetJournal_Dataset_Exp/Prototype-Based_Training/From_xDNN_Offline/Optuna/NeuralNetJournal_Prot-Based_TrainWithPCA_Torch_199c_CDEAlpha_Study_LowEpochs_New_Split_FVFromLastConv_xDNNOffline_v3/Trial_0/Base_Line/T1/", 
#     single_training=True, 
#     # model_name=config_dic["xDNN"]["Name"],
#     model_name="xDDN_TestSet_Mean-Shift_kNN=3_FVFromLastConv",
#     fe_layer = "last_conv",
#     # xDNN_Subprocesses = config_dic["xDNN"]["xDNN_Subprocesses"])
#     Nomalization = "L2-Norm",
#     # xDNN_Subprocesses = ["Mean-Shift"], 
#     # bandwidth = 1e-3,
#     xDNN_Subprocesses = ["Custom_Clustering"], 
#     custom_clustering = lambda x: MeanShift(bandwidth=1e-3).fit(x).cluster_centers_,
#     classifier = "kNN", 
#     k_neighbors = 1)
