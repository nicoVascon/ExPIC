...
def objective(trial):
    ...
    if trial is not None:
        ...
        # trial_number = "Manual_Test_1"
        trial_number = "Manual_Alpha=0.0002029026841683182_vTestSet_v3"
    ...
    print("Before Try")
    try:
        from X_MAN.FineTuning import FineTuning_VGG16_vProt_BasedDS_PyTorch_vCDE_Plot as ft
        ...
        # trial_CCE_Alpha = trial.suggest_float("CDE_Alpha", 1e-8, 1e-2, log=True)
        # trial_CCE_Alpha = 1e-7
        trial_CCE_Alpha = 0.0002029026841683182
        ...
        for layer_index in range(initialLayerIndex, len(layers_From_FT)):
            ...
            # if (config_dic["xDNN"]["Feature_Extraction_Layer"] == "last_fc" and layer_from_FT == '36.weight') or (config_dic["xDNN"]["Feature_Extraction_Layer"] == "last_conv" and layer_from_FT == "1.weight"):
                ...
                V_Matrix_path = config_dic["PCA"]["V_Matrix"]
            ...
            # PCA_V_matrix_path = folderDir + exp_name + '/' + config_dic["xDNN"]["Name"] + "/PCA_V_matrix.pt"
            # config_dic["PCA"]["V_Matrix"] = PCA_V_matrix_path
...
# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/xDNN_Covid19_Det/xDNN---Python/FineTuning/results/FineTuning_VGG16_CB/NeuralNetJournal_Dataset_Exp/Prototype-Based_Training/From_xDNN_Offline/Optuna/NeuralNetJournal_Dataset_Prot-Based_TrainWithPCA_Torch_CCEBeta_Study/Trial_19/FineTuning_11.weight_To_End/T1/config.json"
...
# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/COVID-QU-Ex_Dataset/parameters_Offline_PCA_PyTorch_GPU1.json"
# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/COVID-QU-Ex_Dataset/parameters_Offline_PCA_PyTorch_GPU0_LowEpochs.json"
# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/COVID-QU-Ex_Dataset/parameters_Offline_PCA_PyTorch_GPU1_LowEpochs.json"

# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/NeuralNetJournal_Dataset_Exp/parameters_Offline_PCA_PyTorch_GPU0_LowEpochs.json"
# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/NeuralNetJournal_Dataset_Exp/parameters_Offline_PCA_PyTorch_GPU1_LowEpochs.json"

# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/NeuralNetJournal_Dataset_Exp/parameters_Offline_CDE_GPU0_LowEpochs.json"
# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/NeuralNetJournal_Dataset_Exp/parameters_Offline_CDE_GPU1_LowEpochs.json"

# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/NeuralNetJournal_Dataset_Exp/parameters_Offline_PCA_PyTorch_GPU0_LowEpochs_xDNNEvolving.json"
...
# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/NeuralNetJournal_Dataset_Exp/parameters_Offline_GPU0.json"
# config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/NeuralNetJournal_Dataset_Exp/parameters_Offline_GPU1.json"


config_file_path = "/nfs/home/nvasconcellos.it/softLinkTests/X-MAN/Prototype-Based_Training/src/X_MAN/FineTuning/config/NeuralNetJournal_Dataset_Exp/parameters_Offline_PCA_PyTorch_GPU0_LowEpochs_Test.json"
...
# studyName = 'NeuralNetJournal_Dataset_Prot-Based_Train_TestByParts'
# studyName = 'NeuralNetJournal_Dataset_Prot-Based_TrainWithPCA_Torch_LrAndBS_Study_v4'
# studyName = 'COVID-QU-Ex_Dataset_Prot-Based_TrainWithPCA325c_Torch_LrAndBS_Study'
# studyName = 'COVID-QU-Ex_Dataset_Prot-Based_Train_FT_EachL_LastConv_xDNN_Offline'
# studyName = 'Prot-Based_Train_FT_EachL_LastConv_xDNN_Offline_Prot_Recal_PerEpoch'
# studyName = "COVID-QU-Ex_Dataset_Prot-Based_TrainWithPCA_Emulator"
# studyName = "NeuralNetJournal_Dataset_Prot-Based_TrainWithPCA_Torch_CCEBeta_Study"

# studyName = "COVID-QU-Ex_Dataset_Prot-Based_TrainWithPCA_Torch_325c_CCEAlpha_Study_GridSearch_LowEpochs_v4"
# studyName = "COVID-QU-Ex_Dataset_Prot-Based_TrainWithPCA_Torch_325c_CCEAlpha_Study_Test_v2"

# studyName = "NeuralNetJournal_Prot-Based_TrainWithPCA_Torch_115c_CCEAlpha_Study_LowEpochs"

studyName = "Study_Extra_NeuralNetJournal_Prot-Based_TrainWithPCA_Torch_2c_CDEAlpha_Study_LowEpochs_New_Split_FVFromLastConv_xDNNOffline_RecalPCA"
...
# # trial_path = "/nfs/home/nvasconcellos.it/softLinkTests/xDNN_Covid19_Det/xDNN---Python/FineTuning/results/FineTuning_VGG16_CB/COVID-QU-Ex_Dataset/Prototype-Based_Training/Optuna/COVID-QU-Ex_Dataset_Prot-Based_TrainWithPCA_Torch_325c_CCEAlpha_Study_GridSearch_v3/Trial_3/trial_object"
# # with open(trial_path, "rb") as file:
# #     recov_trial = pickle.load(file)
    
# # initialLayerIndex = 11
# # objective(recov_trial)

# study.enqueue_trial({"CDE_Alpha": 0.0002029026841683182})
